      ...
      <div className="w-full overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex justify-between items-center py-3">
            ...
            {/* Logo */}
            <a href="#home" className="cursor-pointer flex-shrink-0">
              <img
            ...
            <button
              className="md:hidden flex flex-col justify-center items-center w-10 h-10 rounded-lg hover:bg-gray-100 transition-all flex-shrink-0"
